      ...
      <Layout>
        ...
        <LayoutContent>
          <CategoryItem
            ...
            icon={CartImg}
          />
          <CategoryItem title="Категория 2" to="/products/category2/" src={CategoryImg} />
          <CategoryItem title="Категория 3" subTitle="Тест" to="/products/category3/" src={CategoryImg} />
        </LayoutContent>
      </Layout>
    </section>
  );
